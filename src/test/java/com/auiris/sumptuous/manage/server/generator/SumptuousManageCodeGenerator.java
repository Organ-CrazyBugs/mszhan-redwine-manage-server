package com.auiris.sumptuous.manage.server.generator;
...
public class SumptuousManageCodeGenerator {
    ...
    private static final String PACKAGE_PATH_SERVICE = packageConvertPath( String.format("%s.service.%s", BASE_PACKAGE, DATASOURCE_NAME) );             //生成的Service存放路径
    private static final String PACKAGE_PATH_SERVICE_IMPL = packageConvertPath( String.format("%s.service.%s.impl", BASE_PACKAGE, DATASOURCE_NAME) );   //生成的Service实现存放路径
    ...
    private static final String MODEL_PACKAGE = String.format("%s.model.%s", BASE_PACKAGE, DATASOURCE_NAME);
    private static final String MAPPER_PACKAGE = String.format("%s.dao.%s", BASE_PACKAGE, DATASOURCE_NAME);


    private static final String AUTHOR = "iblilife@163.com";//@author
    ...
    public static void genModelAndMapper(String tableName) {
        ...
        sqlMapGeneratorConfiguration.setTargetPackage("mapper/" + DATASOURCE_NAME);
    ...
    public static void genService(String tableName) {
        try {
            ...
            data.put("datasourceName", DATASOURCE_NAME);
